...
module.exports = (webpackEnv) => {
          ...
          postcssOptions: {
            plugins: [
              ...
              [
                ...
                {
                  viewportWidth: 800, // (Number) The width of the viewport.
                  viewportHeight: 600, // (Number) The height of the viewport.
      ...
      loaders.push({
        ...
        options: {
          resources: [
            ...
            // path.resolve(__dirname, '../src/styles/utils.scss'),
          ]
        },
      });
    }
  ...
  return {
    ...
    output: {
      ...
      publicPath: '/',
      // publicPath: isEnvDevelopment ? '/' : path.resolve(__dirname, '../dist/'),
    },
